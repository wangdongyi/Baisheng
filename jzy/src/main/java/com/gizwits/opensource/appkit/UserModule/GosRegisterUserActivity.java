...
public class GosRegisterUserActivity extends GosUserModuleBaseActivity implements OnClickListener {
    ...
    private void initView() {
        ...
        back = findViewById(R.id.appCompatImageView);
        ...
        main_layout.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                isShowKeyboard = main_layout.getRootView().getHeight() - (r.bottom - r.top) > CodeUtil.dip2px(GosRegisterUserActivity.this, 100);
            }
        });
    }
