...
public class GosMainActivity extends GosDeviceModuleBaseActivity {
    ...
    private AppCompatImageView imageView_add;
    private TextView textview_home;
    private LinearLayout layout_title;
    private int showHome = 0;
    ...
    private void initHandler() {
        ...
        activity.setOnShowListen(new OnShowHomeListen() {
            @Override
            public void onShow(int show) {
                showHome = show;
                change();
            }
        });
    ...
    private void change() {
        switch (showHome) {
            case 0://首页
                ...
                textView_title.setText("我的设备");
                break;
            case 1://家居
                textview_home.setVisibility(View.VISIBLE);
                imageView_add.setVisibility(View.GONE);
                layout_title.setBackgroundColor(Color.parseColor("#BCC17C"));
                textView_title.setText("我的家居设备");
                break;
            case 2://宠物
                textview_home.setVisibility(View.VISIBLE);
                imageView_add.setVisibility(View.GONE);
                layout_title.setBackgroundColor(Color.parseColor("#D5A386"));
                textView_title.setText("我的宠物设备");
                break;
        }
    }
...
//                getMenuInflater().inflate(R.menu.devicelist_logout, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (i == android.R.id.home) {// activity.logoutToClean();

            // finish();

        } else if (i == R.id.action_QR_code) {
        } else if (i == R.id.action_addDevice) {
        }
    ...
    private void initView() {
        ...
        imageView_add = (AppCompatImageView) findViewById(R.id.imageView_add);
        imageView_back.setImageResource(R.drawable.ic_code);
        imageView_back.setOnClickListener(new NoDoubleClickListener() {
            @Override
            protected void onNoDoubleClick(View v) {
                //二维码
                AndPermission.with(GosMainActivity.this)
        ...
        imageView_add.setOnClickListener(new NoDoubleClickListener() {
            @Override
            protected void onNoDoubleClick(View v) {
                //添加设备
        ...
        public void onClick(View v) {
            ...
            switch (index) {
                ...
                case 1:
                    ...
                    tx2.setTextColor(getResources().getColor(R.color.top_color));
                    tx3.setTextColor(getResources().getColor(R.color.gray));
                    break;
                ...
                case 2:
                    ...
                    tx1.setTextColor(getResources().getColor(R.color.gray));
                    tx2.setTextColor(getResources().getColor(R.color.gray));
                    tx3.setTextColor(getResources().getColor(R.color.top_color));
                    break;
