...
//		setActionBar(true, true, R.string.forget_pass);
    ...
    private void initView() {
        ...
        back = (AppCompatImageView) findViewById(R.id.appCompatImageView);
        ...
        main_layout.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                if (main_layout.getRootView().getHeight() - (r.bottom - r.top) > CodeUtil.dip2px(GosForgetPasswordActivity.this, 100)) {
